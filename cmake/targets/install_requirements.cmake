...
message(STATUS "Running 'cargo install' command to install 'packages/mdbook-trpl' crate...")
if (CMAKE_HOST_LINUX)
    set(ENV_PATH                "${PROJ_CONDA_DIR}/bin:$ENV{PATH}")
    set(ENV_LD_LIBRARY_PATH     "${PROJ_CONDA_DIR}/lib:$ENV{LD_LIBRARY_PATH}")
    set(ENV_CARGO_INSTALL_ROOT  "${PROJ_CONDA_DIR}")
...
execute_process(
    COMMAND ${Rust_CARGO_EXECUTABLE} install --list --root ${PROJ_OUT_REPO_DIR}
    RESULT_VARIABLE RES_VAR
    OUTPUT_VARIABLE OUT_VAR OUTPUT_STRIP_TRAILING_WHITESPACE
    ERROR_VARIABLE  ERR_VAR ERROR_STRIP_TRAILING_WHITESPACE)
remove_cmake_message_indent()
